        ...
        <div class="table-responsive">
            <table class="table text-start align-middle table-bordered table-hover mb-0">
                ...
                <tbody>
                    @php
                    $batchIds = range(1,5);
                    $courses = ['Math', 'Physics', 'English', 'Chemistry', 'History'];
                    $teachers = ['John Doe', 'Jane Doe', 'Bob Smith', 'Alice Johnson', 'John Jackson'];
                    $totalStudents = [123, 234, 345, 456, 567];
                    $scheduleDates = ['2024-01-01', '2024-02-01', '2024-03-01', '2024-04-01', '2024-05-01'];
                    @endphp
...
<div class="container-fluid pt-4 px-4">
    <div class="row g-4">
        <div class="col-sm-12 col-xl-6">
            <div class="bg-secondary text-center rounded p-4">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <h6 class="mb-0">Students (Admission)</h6>
                    <a href="">Show All</a>
                </div>
                <canvas id="Students-Admission"></canvas>
            </div>
        </div>
        <div class="col-sm-12 col-xl-6">
            <div class="bg-secondary text-center rounded p-4">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <h6 class="mb-0">Progress Reports</h6>
                    <a href="">Show All</a>
                </div>
                <canvas id="Progress-Reports"></canvas>
            </div>
        </div>
    </div>
</div>
